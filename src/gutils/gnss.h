...
namespace gnut
{
 ...
 enum GFRQ { // FXX = -1,
             ...
             C01 = 60, C02 = 61, C05 = 62,
             C06 = 63, C07 = 64, C08 = 65,     // BeiDou
...
//              };
 ...
 enum GOBSBAND { BAND_1 = 1,   BAND_2 = 2,   BAND_3 = 3,   BAND_4 = 4,   BAND_5 = 5,
                 BAND_6 = 6,   BAND_7 = 7,   BAND_8 = 8,
                 BAND_A = 101, BAND_B = 102, BAND_C = 103, BAND_D = 104,
                 BAND   = 999  // ""  UNKNOWN
               };
 enum GOBSATTR { ATTR_A, ATTR_B, ATTR_C, ATTR_D, ATTR_E, ATTR_I, ATTR_L, ATTR_M, ATTR_N,
 ...
 enum GOBS {
    ...
    C1A=0,   C1B, C1C,           C1I, C1L, C1M,      C1P, C1S, C1Q, C1W, C1X, C1Y, C1Z,
                  C2C, C2D,      C2I, C2L, C2M,      C2P, C2S, C2Q, C2W, C2X, C2Y,
                       C3D,      C3I,                C3P,      C3Q,      C3X,
    C4A,     C4B,                                                        C4X,
    C5A,     C5B, C5C, C5D,      C5I,                C5P,      C5Q,      C5X,      C5Z,
    C6A,     C6B, C6C,      C6E, C6I, C6L,                C6S, C6Q,      C6X,      C6Z,
                       C7D,      C7I,                C7P,      C7Q,      C7X,      C7Z,
                       C8D,      C8I,                C8P,      C8Q,      C8X,
    ...
    L1A=100, L1B, L1C,           L1I, L1L, L1M, L1N, L1P, L1S, L1Q, L1W, L1X, L1Y, L1Z,
                  L2C, L2D,      L2I, L2L, L2M, L2N, L2P, L2S, L2Q, L2W, L2X, L2Y,
                       L3D,      L3I,                L3P,      L3Q,      L3X,
    L4A,     L4B,                                                        L4X,
    L5A,     L5B, L5C, L5D,      L5I,                L5P,      L5Q,      L5X,      L5Z,
    L6A,     L6B, L6C,      L6E, L6I, L6L,                L6S, L6Q,      L6X,      L6Z,
                       L7D,      L7I,                L7P,      L7Q,      L7X,      L7Z,
                       L8D,      L8I,                L8P,      L8Q,      L8X,
    ...
    D1A=200, D1B, D1C,           D1I, D1L, D1M, D1N, D1P, D1S, D1Q, D1W, D1X, D1Y, D1Z,
                  D2C, D2D,      D2I, D2L, D2M, D2N, D2P, D2S, D2Q, D2W, D2X, D2Y,
                       D3D,      D3I,                D3P,      D3Q,      D3X,
    D4A,     D4B,                                                        D4X,
    D5A,     D5B, D5C, D5D,      D5I,                D5P,      D5Q,      D5X,      D5Z,
    D6A,     D6B, D6C,      D6E, D6I, D6L,                D6S, D6Q,      D6X,      D6Z,
                       D7D,      D7I,                D7P,      D7Q,      D7X,      D7Z,
                       D8D,      D8I,                D8P,      D8Q,      D8X,
    ...
    S1A=300, S1B, S1C,           S1I, S1L, S1M, S1N, S1P, S1S, S1Q, S1W, S1X, S1Y, S1Z,
                  S2C, S2D,      S2I, S2L, S2M, S2N, S2P, S2S, S2Q, S2W, S2X, S2Y,
                       S3D,      S3I,                S3P,      S3Q,      S3X,
    S4A,     S4B,                                                        S4X,
    S5A,     S5B, S5C, S5D,      S5I,                S5P,      S5Q,      S5X,      S5Z,
    S6A,     S6B, S6C,      S6E, S6I, S6L,                S6S, S6Q,      S6X,      S6Z,
                       S7D,      S7I,                S7P,      S7Q,      S7X,      S7Z,
                       S8D,      S8I,                S8P,      S8Q,      S8X,
 ...
 enum GOBS_LC {LC_L1,  LC_L2, LC_L3, LC_L4, LC_L5,
               LC_C1,  LC_C2, LC_C3, LC_C4, LC_C5,
               LC_LIF, LC_CIF,
               LC_UNDEF};
 ...
 GOBSATTR gobs2gobsattr( GOBS o );            // get GOBSATTR enum from GOBS enum
 GOBSBAND gobs2gobsband( GOBS o );            // get GOBSBAND enum from GOBS enum
 GOBSTYPE gobs2gobstype( GOBS o );            // get GOBSTYPE enum from GOBS enum
 ...
 string gobslc2str( GOBS_LC );                // get string from GOBS_LC enum 
