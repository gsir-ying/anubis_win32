...
{   
  ...
  int    irc  = 0;
  string main = "main";
  t_glog glog; glog.mask("anubis.log"); glog.cache_size(30); glog.time_stamp(true);
  ...
  gset.app("G-Nut/Anubis", "2.3", "$Rev: 2843 $","(gnss@pecny.cz)", __DATE__, __TIME__);
