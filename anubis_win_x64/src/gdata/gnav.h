...
#define MAX_GLO_TIMEDIFF    60*15   // NAV GLO validity interval [s]
#define MAX_GAL_TIMEDIFF  3600*4    // NAV GAL validity interval [s]
...
// ----------
class t_gnav; typedef shared_ptr<t_gnav> t_spt_gnav;
class t_gnav : public t_geph
{
 public:
  ...
  virtual t_gtime tot() const { return _epoch; }
