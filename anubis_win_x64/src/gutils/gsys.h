...
#define  R01_MLT_CDMA     156.5        // CDMA                  156.5 * GPS_FRQ = 1600.995 MHz L1OC
#define  R02_MLT_CDMA     122.0        // CDMA                  122.0 * GPS_FRQ = 1248.06  MHz L2OC
...
#define  C01_MLT          154.0        // BDS3: PXA/PXAN
#define  C02_MLT          152.6        //                BDS2: IQX
#define  C05_MLT          115.0        // BDS3: DPX
#define  C06_MLT          124.0        //                BDS2: IQXA
#define  C07_MLT          118.0        // BDS3: DPZ      BDS2: IQX
#define  C08_MLT          116.5        // BDS3: DPX
...
#define  R01_F_CDMA (R01_MLT_CDMA * GLO_FRQ_CDMA)      //  G1    - GLONASS (CDMA)
#define  R02_F_CDMA (R02_MLT_CDMA * GLO_FRQ_CDMA)      //  G2    - GLONASS (CDMA)
...
#define  C01_F      (C01_MLT * BDS_FRQ)                //  B1    - BeiDou-3
#define  C02_F      (C02_MLT * BDS_FRQ)                //  B1    - BeiDou
#define  C05_F      (C05_MLT * BDS_FRQ)                //  B2    - BeiDou-3
#define  C06_F      (C06_MLT * BDS_FRQ)                //  B3    - BeiDou
#define  C07_F      (C07_MLT * BDS_FRQ)                //  B2    - BeiDou-2/3
